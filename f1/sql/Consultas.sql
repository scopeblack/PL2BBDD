...
FROM f1.escuderias e JOIN f1.pilotos_corren_gps pcg ON e.escuderíaref=pcg.escuderiaref
...
SELECT nombre, apellido, pcvg.tiempo
...
SELECT p.nombre, p.apellido, COUNT(*) AS n_gps
FROM f1.pilotos p
